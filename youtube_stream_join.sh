#!/bin/zsh
#
# NOTE: this script is currently obsoleted by the pre-merge script. 
# It can be tweaked to work by mimicking what is done in https://github.com/mrwnwttk/youtube_stream_capture/blob/main/merge.py
#
