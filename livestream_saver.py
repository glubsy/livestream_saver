...
def _get_target_params(
    ...
    if sub_cmd == "monitor":
        for regex_str in ("allow_regex", "block_regex"):
            try:
                params["regex_filters"][regex_str] = _get_regex_from_config(
            ...
            for regex_str in ("allow_regex", "block_regex"):
                try:
                    if re := _get_regex_from_config(section, config, regex_str):
                        params["regex_filters"][regex_str] = re
                except EmptyRegexException:
                    ...
                    params["regex_filters"][regex_str] = None
    ...
    while True:
        ...
        try:
            live_broadcast = YoutubeLiveBroadcast(
                ...
                regex_filters=args.get("regex_filters", {}),
...
def main():
    ...
    if sub_cmd == "monitor":
        ...
        args["regex_filters"] = params.get("regex_filters", {})
